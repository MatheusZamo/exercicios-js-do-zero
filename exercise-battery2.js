...
const url = pokemon.moves[0].versionGroupDetails[1].versionGroup.url
...
const paragrafo = `Nesta bateria de exercícios vimos que marca armazena um array no qual o segundo item é ${marcas[1]}, um dos gêneros da banda ${banda.nome} é ${banda.generos[3]} e que a propriedade moveLearnMethod do Articuno contém um objeto com uma propriedade name que armazena "${pokemon.moves[0].versionGroupDetails[1].moveLearnMethod.name}".`
