...
multiplica(obj.prop1,obj.prop2)
...
multiplica(numbers[0],numbers[1])
...
multiplica(pegaNumerosImpares()[1],pegaNumerosImpares()[2])
...
const pegaObj = () => [{prop:2},{prop:4},{prop:6}]

multiplica(pegaObj()[0].prop,pegaObj()[2].prop)
...
const respostasUsuario = pegaPontuacao(pegaRespostasUsuario())
