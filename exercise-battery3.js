...
function y () {
  ...
  */
  ...
  const multiplicaContador = numero => numero * 100
  ...
  */
  ...
  const divideContador = numero => numero / 4
  ...
  */
  ...
  const incrementaContador = numero => numero += 1
  ...
  */
  ...
  const decrementaContador = numero => numero -= 1
  ...
  */
  ...
  contador = multiplicaContador(contador)
  ...
  */
  ...
  contador = divideContador(contador)
  ...
  */
  ...
  contador = decrementaContador(contador)
