...
const consertaPalavra = str => {
  const palavraCorreta = str.replace('serto','certo')
...
const saoMesmaVersao = obj => obj.versoes
 .every(arrVersao => arrVersao[0] !== 7 ?  false : true)
...
const arquivosJs = arquivos.every(arquivo => arquivo.includes('js'))
...
Teste sua função usando os dois arrays abaixo.a
...
const juntandoArrays = (arr1,arr2) => {
  return [...arr1, ...arr2]
} 
//console.log(juntandoArrays(bandasAnos60,bandasAnos70))
/*
08
...
const novoProduto = mudaNomeProduto(produtos2[0])
